...
Encoder.load_state_dict(torch.load('EncoderAuto30.pt'))
Decoder.load_state_dict(torch.load('DecoderAuto30.pt'))
Cf.load_state_dict(torch.load('CfAuto30.pt'))
...
#             print()
            ...
            if th and vaccuracy > best_loss:
                ...
                torch.save(Encoder.state_dict(), 'EncoderAuto30.pt')
                torch.save(Decoder.state_dict(), 'DecoderAuto30.pt')
                torch.save(Cf.state_dict(), 'CfAuto30.pt')
                print('##############################################')
