...
pickle_file_path = '/media/terminator/NatureData/Auto Thirty Minutes.pkl'
...
if train:
    ...
    for epoch in range(num_epochs):
        ...
        if th and vaccuracy > best_loss:
            ...
            torch.save(Encoder.state_dict(), 'EncoderAuto302.pt')
            torch.save(Decoder.state_dict(), 'DecoderAuto302.pt')
            torch.save(Cf.state_dict(), 'CfAuto302.pt')
            print('##############################################')
...
Encoder.load_state_dict(torch.load('EncoderAuto302.pt'))
Decoder.load_state_dict(torch.load('DecoderAuto302.pt'))
Cf.load_state_dict(torch.load('CfAuto302.pt'))
