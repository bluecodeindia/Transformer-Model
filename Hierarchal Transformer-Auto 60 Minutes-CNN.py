...
Encoder.load_state_dict(torch.load('EncoderAuto60.pt'))
Decoder.load_state_dict(torch.load('DecoderAuto60.pt'))
Cf.load_state_dict(torch.load('CfAuto60.pt'))
...
#             print()
            ...
            if th and vaccuracy > best_loss:
                ...
                torch.save(Encoder.state_dict(), 'EncoderAuto60.pt')
                torch.save(Decoder.state_dict(), 'DecoderAuto60.pt')
                torch.save(Cf.state_dict(), 'CfAuto60.pt')
                print('##############################################')
